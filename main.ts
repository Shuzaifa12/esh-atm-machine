...
let pin: any[] = ["1245"]; // initially assigned the value of password
...
let initial_message: string =
  " ** you are succesfully login into your account ** ";
let wrong_pass: string =
...
if (pin.includes(password.pass)) {
  ...
  // if option is equal to withdraw  amount it will ask how much amount you want to withdraw
    ...
    if (withdraw.amount <= Balance) {
      ...
      console.log(
        `After withdrawing ${withdraw.amount}`,
        " Your new balance is = ",
        Balance
      );
    }
    // other wise it will show following message of insuffiency
      ...
      console.log(
        "You don't have sufficient balance in your account, and your current balance is",
        Balance
      );
    }
  }
